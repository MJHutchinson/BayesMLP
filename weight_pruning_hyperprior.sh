...
python parameter_sweep.py -c ./config/weight_pruning_hyperprior/mnist.yaml                      -ds mnist                        -ld /scratch/mjh252/logs/clean/ -dd /scratch/mjh252/data/presplit/ -cm weight_pruning_hyperprior -nd --gpu 0 1 2 3 &
