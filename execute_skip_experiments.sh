...
python experiment_parametrise_skip_connect.py -c ./config/skips/concrete.yaml                   -ds concrete                    -ld /scratch/mjh252/logs -dd /scratch/mjh252/data/UCL/ -cm skips2 &
...
#python experiment_parametrise_skip_connect.py -c ./config/protein-tertiary-structure.yaml -ds protein-tertiary-structure  -ld /scratch/mjh252/logs -dd /scratch/mjh252/data/UCL/ -cm skips &
