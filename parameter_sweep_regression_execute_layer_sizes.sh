...
python parameter_sweep.py -c ./config/parameter_sweep_layer_sizes/energy.yaml                     -ds energy                      -ld /scratch/mjh252/logs/clean -dd /scratch/mjh252/data/presplit/ -cm sweep-hidden-sizes -nd --gpu 4 5 6 &

#wait

python parameter_sweep.py -c ./config/parameter_sweep_layer_sizes/concrete.yaml                   -ds concrete                    -ld /scratch/mjh252/logs/clean -dd /scratch/mjh252/data/presplit/ -cm sweep-hidden-sizes -nd --gpu 4 5 6 &
...
python parameter_sweep.py -c ./config/parameter_sweep_layer_sizes/power-plant.yaml                -ds power-plant                 -ld /scratch/mjh252/logs/clean -dd /scratch/mjh252/data/presplit/ -cm sweep-hidden-sizes -nd --gpu 4 5 6 &

#wait

python parameter_sweep.py -c ./config/parameter_sweep_layer_sizes/protein-tertiary-structure.yaml -ds protein-tertiary-structure  -ld /scratch/mjh252/logs/clean -dd /scratch/mjh252/data/presplit/ -cm sweep-hidden-sizes -nd --gpu 4 5 6 &
