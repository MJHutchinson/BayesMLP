...
import argparse
from model.regression import BayesMLPRegression, BaysMLPRegressionTFP, BayesSkipMLPRegression
...
data_loader = data.DummyDataloader()
...
skips = [[(0,1), (0,2), (1,2)], [(0,1), (0,2),], [(0,1), (1,2)], [(0,2), (1,2)], [(0,1)], [(0,2)], [(0,1)], []]
