...
python parameter_sweep.py -c ./config/parameter_sweep_prior_widths/energy.yaml                     -ds energy                      -ld /scratch/mjh252/logs/pytorch -dd /scratch/mjh252/data/presplit/ -cm sweep-prior-var -nd --gpu 4 5 6 7 &

wait

python parameter_sweep.py -c ./config/parameter_sweep_prior_widths/concrete.yaml                   -ds concrete                    -ld /scratch/mjh252/logs/clean -dd /scratch/mjh252/data/presplit/ -cm sweep-prior-var -nd --gpu 4 5 6 7 &
...
python parameter_sweep.py -c ./config/parameter_sweep_prior_widths/power-plant.yaml                -ds power-plant                 -ld /scratch/mjh252/logs/clean -dd /scratch/mjh252/data/presplit/ -cm sweep-prior-var -nd --gpu 4 5 6 7 &

wait

python parameter_sweep.py -c ./config/parameter_sweep_prior_widths/protein-tertiary-structure.yaml -ds protein-tertiary-structure  -ld /scratch/mjh252/logs/clean -dd /scratch/mjh252/data/presplit/ -cm sweep-prior-var -nd --gpu 4 5 6 7 &
